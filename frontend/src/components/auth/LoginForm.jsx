...
export default function LoginForm() {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    const result = await authService.login(credentials.userEmail, credentials.userPassword);
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <button
        type="submit"
        className="w-full flex items-center justify-center py-3.5 px-6 bg-gradient-to-r from-indigo-600 to-purple-600 text-white rounded-xl hover:from-indigo-500 hover:to-purple-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition-all duration-300 shadow-lg shadow-indigo-600/20 group relative overflow-hidden"
      >
        ...
        <span className="relative font-medium text-base z-10">Se connecter</span>
