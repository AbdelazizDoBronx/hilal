  ...
  return (
    ...
    >
      ...
      <motion.button
        ...
        whileTap={{ scale: 0.97 }}
        onClick={onAddClick}
        className="flex items-center py-2.5 px-4 bg-gradient-to-r from-indigo-600 to-purple-600 text-white rounded-xl hover:from-indigo-500 hover:to-purple-500 transition-all duration-300 shadow-md shadow-indigo-600/20 font-medium"
      >
